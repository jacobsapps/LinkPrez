...
let chatMessages: [ChatMessage] = [
    ...
    ChatMessage(id: UUID().uuidString, firstName: "Bob", text: "Hey, check this out!\nhttps://blog.jacobstechtavern.com/p/the-swift-compiler", date: Date().addingTimeInterval(-10000).addingTimeInterval(100 * 41)),
    ChatMessage(id: UUID().uuidString, firstName: "Alice", text: "I love Jacob's stuff - read this!\nhttps://blog.jacobstechtavern.com/p/how-i-stole-your-api-keys", date: Date().addingTimeInterval(-10000).addingTimeInterval(100 * 42))
]
